    ...
    <section className="flex flex-col gap-6 px-5 py-[4rem] md:px-10 max-h-auto relative h-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-6 items-start">
        ...
        <div className="grid justify-between h-full">
          ...
          <Link
            href={"/contato"}
            className="pl-[1px] font-1-s self-center py-2 cursor-pointer bg-transparent cor-p2 hover:bg-transparent rounded-2xl max-h-fit max-w-fit duration-200 relative animatedUnderline flex gap-2 items-center after:min-w-full lg:after:min-w-0"
          >
