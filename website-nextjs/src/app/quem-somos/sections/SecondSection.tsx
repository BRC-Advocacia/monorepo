...
const SecondSection = () => {
  return (
    <section className="px-5 md:px-10 bg-(--background) py-[4rem] cor-azul-escuro text-center sm:text-start">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-6">
        <div className="flex flex-col justify-start gap-6 font-1-s">
          <p>
            ...
            estratégias para inovar a atuação jurídica. Reformulou sua prática
            de contencioso adequando-a à necessidade do mercado por soluções
          ...
          <p>
            ...
            da sociedade de advogados - BRCR.
          </p>
        </div>
        <Image
