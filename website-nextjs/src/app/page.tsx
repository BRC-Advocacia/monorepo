    ...
    <section>
      <div>
        <Image
          ...
          width={1200}
          height={1200}
          className="w-screen h-screen object-cover object-top absolute top-0 z-[-100]"
          sizes="100vw"
        />
        <div className="w-screen h-screen object-cover object-top absolute top-0 bg-sky-950/50 z-[-90]" />
      </div>
      <div className="h-screen flex flex-col justify-center items-center">
        ...
        <p className="text-slate-200/65 font-2-l mt-5">
