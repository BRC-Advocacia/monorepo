...
export const InfiniteMovingCards = ({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "scroller relative z-20 max-w-screen md:max-w-[90vw] lg:max-w-7xl overflow-hidden [mask-image:linear-gradient(to_right,transparent,#f2f2f2_20%,#f2f2f2_80%,transparent)]",
        className
      )}
    >
      <ul
